...
/*-----------------------------------------------------------------------------------------
  ...
  --------     ----         -------------------------------------    ----------------------
  2011-05-17   lijing       modify af setting for cts                ZTE_CAM_LJ_20110517
...
static int32_t mt9p111_af_trigger(void)
{
	...
	/*
	 * ZTE_CAM_LJ_20110517
	 * modify af settings for cts 0x0085->00C1
	 */
    rc = mt9p111_i2c_write(mt9p111_client->addr, 0xB002, 0x00C1, WORD_LEN);
