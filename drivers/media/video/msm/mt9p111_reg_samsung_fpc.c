...
static struct mt9p111_i2c_reg_conf const preview_snapshot_mode_reg_settings_array[] = {
    ...
    {0xC8AA, 0x0400, WORD_LEN, 0}, 	// CAM_OUTPUT_0_IMAGE_WIDTH //0x0280 lijing 20120101
    {0xC8AC, 0x0300, WORD_LEN, 0}, 	// CAM_OUTPUT_0_IMAGE_HEIGHT //0x01e0 
    ...
    {0xB002, 0x00C5, WORD_LEN, 0},     
    {0x8404, 0x06, BYTE_LEN, 250},
};
