...
#include <linux/i2c/akm8962_private.h>
...
static int __init akm8962_init(void)
{
	...
	if(0 == ret){
		printk(ZTE_TAG"This is old hardware version which is used AK8973 in %s\n",__func__);
		printk(ZTE_TAG"Do not register AKM8962 compass driver\n");
		return -EAGAIN;
	}
#endif	
